...
class Castillo {
  ...
  public static function update($idNuevo, $tituloNuevo, $descripcionNueva, $imagenNueva) {
    $conexion = GoTeamDB::connectDB();
    $update = "UPDATE USUARIO SET id=\"".$idNuevo."\", titulo=\"".$tituloNuevo."\", descripcion=\"".$descripcionNueva."\", imagen=\"".
            imagenNueva."\" WHERE id=".$idNuevo;
